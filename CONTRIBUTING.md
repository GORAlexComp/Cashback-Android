...
Допомагаючи цьому репозиторію, спочатку обговоріть зміни, які ви хочете внести, через [звернення](https://github.com/GORAlexComp/Cashback-Android/issues), електронну пошту чи будь-який інший метод з власниками цього репозиторію, перш ніж вносити зміни.
